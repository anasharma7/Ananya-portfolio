...
const skills = [
  {
    ...
    description: 'Transforming ideas into visually stunning, intuitive experiences that captivate and inspire.',
  ...
  },
  {
    ...
    title: 'Code Poetry',
    description: 'Writing elegant, efficient code that brings digital dreams to life with precision and grace.',
    gradient: 'from-blue-500 to-cyan-500',
    color: 'blue'
  },
  {
    icon: <FaShieldAlt className="h-8 w-8" />,
    title: 'Security Symphony',
    description: 'Crafting robust, secure solutions that protect and empower in an ever-evolving digital landscape.',
  ...
  },
  {
    ...
    description: 'Solving complex challenges with creative thinking and cutting-edge technology solutions.',
  ...
  },
  {
    ...
    description: 'Optimizing every interaction for speed, efficiency, and seamless user experiences.',
  ...
  },
  {
    ...
    title: 'User Empathy',
    description: 'Designing with heart, understanding user needs and creating meaningful connections.',
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-4xl mx-auto text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            I transform complex challenges into elegant digital experiences that inspire and empower.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  {/* Glow effect */}
                  <div
                    className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${skill.gradient} opacity-0 transition-opacity duration-500 ${
                  ...
                  <div className="relative z-10 p-8 h-full flex flex-col items-center justify-center text-center">
                    <div className={`w-16 h-16 bg-gradient-to-br ${skill.gradient} rounded-2xl flex items-center justify-center text-white shadow-lg mb-6 transform transition-all duration-300 ${
